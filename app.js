...
async function sendRequest(inputWord) {
  try {
    ...
    // calling the output word function to output the typed word
    ...
    // Formatting the result within the result container
    ...
    // loop through the result and getting part of speeches
